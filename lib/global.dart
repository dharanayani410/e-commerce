class Global {
  static List<Map<String, dynamic>> menu = [
    {
      'item': 'Pizza',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOGvaFNhnDYtJh8lAVIpl3xrmGS-ggP6A3Cw&usqp=CAU',
      'list': pizza,
    },
    {
      'item': 'Salad',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQM8NzULMGJcP2a5W09ll6n2MwCY3OWjd59Q&usqp=CAU',
      'list': salad,
    },
    {
      'item': 'Desserts',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTA9lB1AqSbBVe5uD1CgHwJrU2czMtEnmxNCA&usqp=CAU',
      'list': dessert,
    },
    {
      'item': 'Pasta',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxDKqRn1G328qthVokQVqLzRnhLhT38oxiHOZzmSWgH_R2HguA0OPfsvay0wibMlU7rt0&usqp=CAU',
      'list': pasta
    },
    {
      'item': 'Beverages',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6uBRcIU4UVuU44Sy-ZxIHJeDHACtlXKDIjg&usqp=CAU',
      'list': beverages,
    }
  ];
  static List<Map<String, dynamic>> pizza = [
    {
      'title': 'Pizza',
      'item': 'Seven Cheesy Pizza',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWwBoezWalVrjujiIG8npsNtmukgtN-Cen-g&usqp=CAU',
    ...
    },
    {
      ...
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSFF8PErjfcRq_lYAHhj2OrrqqTdY0FKohDA&usqp=CAU',
      'detail': ' Lots of cheese',
      'price': 350,
      'i': 0,
    },
    {
      ...
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS90tVaQ3DnoWl0Q_k-SBSGD4el3AvmYoSXOw&usqp=CAU',
    ...
    },
    {
      ...
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVF3tggw2QnSyZg0Lw6E59EYZ2TMVi_XaYMQ&usqp=CAU',
    ...
    },
    {
      ...
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSppSgaq4TSDd5dF6tFuqm4j8aLw8HTrwzb-Q&usqp=CAU',
    ...
    },
    {
      ...
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLYKXPWkNy9H8uVzrOIhRzEtm3E3Ug7uosSg&usqp=CAU',
  ...
  static List<Map<String, dynamic>> salad = [
    {
      ...
      'item': 'Cucumber Salad',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAVpDl6DloSKYLTMSSyAcaQ9YrXayhQ_msQA&usqp=CAU',
    ...
    },
    {
      'item': 'Greek Salad',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRP6BuOWHh7oM2cHY2WjhCXSoHTrqOn7q1HEQ&usqp=CAU',
      'detail':
    ...
    },
    {
      ...
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLqDlN2K9GcWaSQ6CjvhHkbO1SQW2Pcu6eeg&usqp=CAU',
    ...
    },
    {
      'item': 'Chef Salad',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTjSlwQGcGo3od47OmWI51WRpqps4ln8YWNBg&usqp=CAU',
  ...
  static List<Map<String, dynamic>> pasta = [
    {
      ...
      'item': 'Macroni Pasta',
      'image':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTt6S53_RC3lj42dJYTXXNTxTLIs8zft45TSg&usqp=CAU',
